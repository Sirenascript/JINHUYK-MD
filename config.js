...
module.exports = {
  ...
  author: process.env.PACK_AUTHER || "𝐋𝐢𝐦𝐮𝐥 𝐬𝐚𝐬𝐚𝐤𝐢",
  packname: process.env.PACK_NAME || "𝐬𝐨𝐥𝐢𝐭𝐚𝐢𝐫𝐞 𝐬𝐬𝐤-𝐌𝐃",
  botname: process.env.BOT_NAME || "𝐋𝐢𝐦𝐮𝐥 𝐬𝐚𝐬𝐚𝐤𝐢-𝚳𝐃",
  ownername: process.env.OWNER_NAME || "𝚕𝚒𝚖𝚞𝚕 𝚜𝚘𝚕𝚒𝚝𝚊𝚒𝚛𝚎",
